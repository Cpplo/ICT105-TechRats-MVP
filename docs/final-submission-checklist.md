...
Marked for Lab 14 submission based on the current project workspace and packaged deliverables.
...
- The current project contains the prototype, documentation, screenshots, pitch materials, and sample data needed for final submission.
- If you are submitting the ZIP package, make sure the folder structure inside the archive still keeps the required project files together and easy to find.
